        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Affordable furniture & appliance rentals for modern living. 
              Flexibility, convenience, and quality at your fingertips.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=appliances" className="text-gray-400 hover:text-white transition-colors">
                  Appliances
                </Link>
              </li>
              <li>
